...
#####################################################################################################################
# This file is used to fully study the case of a triichromatic laser source <-> E(t)=E0*sin(wt+phi1)+E2*sin(2wt+phi2)+E3*sin(3wt+phi3)
...
plt.yticks( np.arange(5)-2*E0, (r"$-2E_{0}$", r"$-E_{0}$" , r"$0$", r"$E_{0}$", r"$2E_{0}$"), fontsize=30)
plt.grid()
plt.tight_layout() 
"""
...
"""
#the list we get is : [0.16, 0.17, 0.18, 0.19, 0.2, 0.21, 0.22, 0.23, 0.24, 0.25, 0.26, 0.27, 0.28, 0.29, 0.3, 0.31, 0.32, 0.33, 0.34, 0.35000000000000003, 0.36, 0.37, 0.38, 0.39, 0.4, 0.41000000000000003, 0.42, 0.43, 0.44, 0.45, 0.46, 0.47000000000000003, 0.48, 0.49, 0.63, 0.64, 0.65, 0.66, 0.67, 0.68, 0.6900000000000001, 0.7000000000000001, 0.71, 0.72, 0.73, 0.74, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89, 0.9, 0.91, 0.92, 0.93, 0.9400000000000001, 0.9500000000000001, 0.96, 0.97, 0.98]



"""Initialization of vectors of ionization time using the precedent result"""

#We can choose to work either on the reunion of [0.17*T,0.48*T], [0.64*T,0.74*T] and [0.85*T, 0.98*T] in order to be sure to take good ionization times.

TPRIME=np.linspace(0.17*T,0.48*T,100)
TPRIME_bis=np.linspace(0.64*T,0.74*T,100)
TPRIME_ter=np.linspace(0.85*T,0.98*T,100)
...
plt.yticks( np.arange(4)*(T)*0.5, (r"$0$", r"$\frac{T}{2}$",r"$T$",r"$\frac{3T}{2}$"), fontsize=30)
...
plt.xticks( np.arange(4)*(T)*0.5, (r"$0$", r"$\frac{T}{2}$",r"$T$",r"$\frac{3T}{2}$"), fontsize=30)
plt.tight_layout()
...
plt.grid() 
plt.xticks( np.arange(3)*(T), (r"$0$", r"$T$",r"$2T$"), fontsize=30)
plt.yticks(fontsize=30)
plt.xlabel('Return Time $t_r$ (T)', fontsize=30)
